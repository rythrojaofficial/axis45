...
const navUpcoming = new NavText('upcoming events', 'upcoming-link', 'https://www.seattletricking.com/upcoming');
const navMemberships = new NavText('memberships', 'memberships-link', 'https://www.seattletricking.com/memberships');
